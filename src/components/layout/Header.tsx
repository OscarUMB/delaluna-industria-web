    ...
    <header className="relative z-50 border-b border-brand-green-deep/20 bg-surface-primary text-text-primary">
      <Container>
        <div className="flex min-h-16 items-center justify-between gap-6 py-2">
          <Link
            href="/"
            className="inline-flex min-h-11 items-center font-serif text-xl font-semibold text-brand-green-deep focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green-deep focus-visible:ring-offset-2 focus-visible:ring-offset-surface-primary"
            ...
            <ul className="flex items-center gap-1">
              {navigationItems.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="inline-flex min-h-11 items-center rounded-md px-3 py-2 text-sm font-medium text-text-primary hover:bg-surface-soft hover:text-brand-green-deep focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green-deep"
                  >
                    {item.label}
                  </Link>
                </li>
